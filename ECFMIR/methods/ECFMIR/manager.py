        ...
        for epoch in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm(self.train_dataloader, desc="Iteration")):
                ...
                with torch.set_grad_enabled(True):
                    ...
                    last_hiddens = outputs['features']

                    topK_distance_loss = topK_distance(last_hiddens, label_ids, margin=1.0)

                    # 1. 主分类损失
                    cls_loss = self.criterion(preds, label_ids)


                    # 总 loss
                    loss = (
                            cls_loss + topK_distance_loss
                    )
