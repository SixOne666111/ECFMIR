...
def parse_arguments():
    ...
    parser.add_argument('--method', type=str, default='ecfmir', help="which method to use.")
    ...
    parser.add_argument("--tune", default=True, help="Whether to tune the model with a series of hyper-parameters.")
    ...
    parser.add_argument("--config_file_name", type=str, default='ecfmir_bert.py',
                        help="The name of the config file.")

    parser.add_argument("--results_file_name", type=str, default='trust.csv',help="The file name of all the experimental results.,or misa_bert_bi.csv")
