...
class TextDataset:
    ...
    def _get_feats(self, args, base_attrs):
        ...
        train_examples = processor.get_examples(base_attrs['data_path'], 'train', args)
        train_feats = self._get_bert_feats(args, train_examples, base_attrs)

        dev_examples = processor.get_examples(base_attrs['data_path'], 'dev', args)
        dev_feats = self._get_bert_feats(args, dev_examples, base_attrs)

        test_examples = processor.get_examples(base_attrs['data_path'], 'test', args)
...
class DatasetProcessor(DataProcessor):
    ...
    def get_examples(self, data_dir, mode, args):
        if mode == 'train':
